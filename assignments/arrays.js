...
console.log('The make and model of the last car in the inventory is: ' + lastCar.car_make + " " + lastCar.car_model);
...
let BMWAndAudi = [];
console.log('The following are all BMW & Audi cars within our inventory:' + inventory.BMWAndAudi);
